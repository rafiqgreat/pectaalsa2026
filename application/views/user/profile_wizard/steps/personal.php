...
<form id="profileFormStep1" class="signup-step-form" autocomplete="off">
	<div class="form-row">
		<div class="form-group col-md-3">
			<label>CNIC<span class="text-danger">*</span></label>
			<input
				type="text"
				class="form-control js-cnic bg-light"
				id="cnic"
				name="cnic"
				inputmode="numeric"
				autocomplete="off"
	...
	<div class="form-group">
		...
		<input type="hidden" name="profile_picture_path" class="js-upload-path" value="<?php echo html_escape($u->profile_picture ?? ''); ?>">
		<div class="upload-meta js-upload-meta">
			<span class="label">File name:</span> <?php echo !empty($u->profile_picture) ? html_escape(basename($u->profile_picture)) : '-'; ?>
