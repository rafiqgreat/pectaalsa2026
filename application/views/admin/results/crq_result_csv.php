...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form method="get" action="<?php echo base_url('admin/emarking/reports_crq_csv'); ?>" class="mb-3">
          <div class="form-row">
          ...
          <div class="form-row">
            ...
            <div class="col-md-3 mb-2">
              <a href="<?php echo base_url('admin/emarking/export_crq_results_csv?' . http_build_query($filters ?? [])); ?>" class="btn btn-primary btn-block">Export CSV</a>
            </div>
          </div>
        </form>
