...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><?php echo htmlspecialchars((string) ($page->title ?? 'CRQ Result CSV')); ?></h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Home</a></li>
          <li class="breadcrumb-item active">Results</li>
          <li class="breadcrumb-item active">CRQ Result CSV</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
          <h3 class="card-title mb-0">CRQ Result CSV</h3>
          <div class="btn-group btn-group-sm">
            <a class="btn btn-primary" href="<?php echo base_url('admin/emarking/reports_crq_csv'); ?>">CRQ Result CSV</a>
          </div>
        </div>
      </div>
      <div class="card-body">
        <form method="get" action="<?php echo base_url('admin/emarking/reports_crq_csv'); ?>" class="mb-3" id="crq-filter-form">
          <div class="form-row">
            ...
            <div class="col-md-2 mb-2">
              <input type="text" class="form-control" value="CRQ" readonly>
            </div>
          </div>
          <div class="form-row">
            <div class="col-md-2 mb-2">
            ...
            <div class="col-md-2 mb-2">
              <a href="<?php echo base_url('admin/emarking/reports_crq_csv'); ?>" class="btn btn-outline-secondary btn-block">Reset</a>
            </div>
            <div class="col-md-3 mb-2">
              <a href="<?php echo base_url('admin/emarking/export_crq_results_csv?' . http_build_query($filters ?? [])); ?>" class="btn btn-primary btn-block" id="crq-export-link">Export CSV</a>
            </div>
          </div>
        </form>
            ...
            <table class="table table-bordered table-sm table-hover mb-0">
              ...
              <tbody>
                <?php if (empty($preview_rows)): ?>
                  <tr>
                    <td colspan="<?php echo count((array) ($csv_headers ?? [])); ?>" class="text-center text-muted">No CRQ result rows found for the selected filters.</td>
                  </tr>
                <?php else: ?>
...
<script>
  (function () {
    var exportLink = document.getElementById('crq-export-link');
    var filterForm = document.getElementById('crq-filter-form');
    ...
    exportLink.addEventListener('click', function () {
      ...
      exportLink.href = '<?php echo base_url('admin/emarking/export_crq_results_csv'); ?>?' + params.toString();
    });
  })();
</script>
