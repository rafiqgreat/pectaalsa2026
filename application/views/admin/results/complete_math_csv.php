...
$tableName = trim((string) ($csv_table_name ?? 'fullbook_complete_result_math'));
...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><?php echo htmlspecialchars((string) ($page->title ?? 'Complete Math CSV')); ?></h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Home</a></li>
          <li class="breadcrumb-item active">Results</li>
          <li class="breadcrumb-item active">Complete Math CSV</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
          <h3 class="card-title mb-0">Complete Math CSV</h3>
          <div class="btn-group btn-group-sm">
            <a class="btn btn-primary" href="<?php echo base_url('admin/emarking/reports_complete_math_csv'); ?>">Complete Math CSV</a>
          </div>
        </div>
      </div>
      <div class="card-body">
        ...
        <?php else: ?>
          <form method="get" action="<?php echo base_url('admin/emarking/reports_complete_math_csv'); ?>" class="mb-3" id="complete-math-export-form">
            <div class="form-row align-items-end">
              ...
              <div class="col-md-3 mb-2">
                <a href="<?php echo base_url('admin/emarking/export_complete_math_csv' . ($includeMcqStatus ? '?include_mcq_status=1' : '')); ?>" class="btn btn-primary btn-block" id="complete-math-export-link">Export CSV</a>
              </div>
            </div>
          </form>
            ...
            <table class="table table-bordered table-sm table-hover mb-0">
              ...
              <tbody>
                <?php if (empty($previewRows)): ?>
                  <tr>
                    <td colspan="<?php echo count($csvHeaders); ?>" class="text-center text-muted">No rows found in the complete Math result table.</td>
                  </tr>
                <?php else: ?>
...
<script>
  (function () {
    var exportLink = document.getElementById('complete-math-export-link');
    ...
    function updateExportLink() {
      var url = '<?php echo base_url('admin/emarking/export_complete_math_csv'); ?>';
