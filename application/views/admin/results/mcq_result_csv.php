...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><?php echo htmlspecialchars((string) ($page->title ?? 'MCQ Result CSV')); ?></h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Home</a></li>
          <li class="breadcrumb-item active">Results</li>
          <li class="breadcrumb-item active">MCQ Result CSV</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
          <h3 class="card-title mb-0">MCQ Result CSV</h3>
          <div class="btn-group btn-group-sm">
            <a class="btn btn-primary" href="<?php echo base_url('admin/emarking/reports_mcq_csv'); ?>">MCQ Result CSV</a>
          </div>
        </div>
      </div>
      <div class="card-body">
        <form method="get" action="<?php echo base_url('admin/emarking/reports_mcq_csv'); ?>" class="mb-3" id="mcq-filter-form">
          <div class="form-row">
            ...
            <div class="col-md-2 mb-2">
              <input type="text" class="form-control" value="MCQ" readonly>
            </div>
          </div>
          <div class="form-row">
            <div class="col-md-2 mb-2">
            ...
            <table class="table table-bordered table-sm table-hover mb-0">
              ...
              <tbody>
                <?php if (empty($preview_rows)): ?>
                  <tr>
                    <td colspan="<?php echo count((array) ($csv_headers ?? [])); ?>" class="text-center text-muted">No MCQ result rows found for the selected filters.</td>
                  </tr>
                <?php else: ?>
