    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Synchronize Eng Dict</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="col-sm-9">
      ...
      <div class="card">
        <div class="card-header with-border">
          <h3 class="card-title">Synchronize Missing English Dictation Images</h3>
        </div>
        <div class="card-body">
          <div class="alert alert-info">
            <div><strong>Source table:</strong> <code>tbl_missing_barcodes_englishdict</code></div>
            <div><strong>Source path:</strong> <code>storagebox/dictations/{1st}/{8th}/{9th}/{12th-14th}/q1|q2/</code></div>
            <div><strong>Target path:</strong> <code>storagebox/mdictations/{1st}/{8th}/{9th}/{12th-14th}/q1|q2/</code></div>
          ...
          <form method="post" action="<?php echo url('admin/settings/sync_eng_dict'); ?>" class="mb-3">
