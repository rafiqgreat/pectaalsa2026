...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Synchronize Science CRQs</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Synchronize Science CRQs</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="col-sm-9">
      ...
      <div class="card">
        <div class="card-header with-border">
          <h3 class="card-title">Synchronize Missing Science CRQ Images</h3>
        </div>
        <div class="card-body">
          <div class="alert alert-info">
            <div><strong>Source table:</strong> <code>tbl_missing_barcodes_sciencecrq</code></div>
          ...
          <div class="row mb-3">
            <div class="col-md-4"><div class="small-box bg-info"><div class="inner"><h3><?php echo number_format((int) ($counts['total'] ?? 0)); ?></h3><p>Total Rows</p></div></div></div>
            <div class="col-md-4"><div class="small-box bg-warning"><div class="inner"><h3><?php echo number_format((int) ($counts['pending'] ?? 0)); ?></h3><p>Pending</p></div></div></div>
            <div class="col-md-4"><div class="small-box bg-success"><div class="inner"><h3><?php echo number_format((int) ($counts['done'] ?? 0)); ?></h3><p>Synchronized</p></div></div></div>
          </div>

          <form method="post" action="<?php echo url('admin/settings/sync_science_crqs'); ?>" class="mb-3">
            ...
            <?php if (!empty($summary['items'])): ?>
              <div class="table-responsive">
                <table class="table table-bordered table-sm">
                  <thead>
                    <tr><th>ID</th><th>Image Barcode</th><th>Result</th><th>Message</th><th>Source Folder</th><th>Target File</th></tr>
                  </thead>
                  <tbody>
