    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Synchronize Math CRQs</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="col-sm-9">
      ...
      <div class="card">
        <div class="card-header with-border">
          <h3 class="card-title">Synchronize Missing Math CRQ Images</h3>
        </div>
        <div class="card-body">
          <div class="alert alert-info">
            <div><strong>Source table:</strong> <code>tbl_missing_barcodes_mathcrq</code></div>
          ...
          <form method="post" action="<?php echo url('admin/settings/sync_math_crqs'); ?>" class="mb-3">
