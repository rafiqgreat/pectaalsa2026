...
<style>
  ...
  .admin-profile-tabs .nav-link.active:focus,
  .admin-profile-tabs .nav-link.active:hover {
    background: #1b5e20 !important;
    color: #ffffff !important;
    border-color: #1b5e20 !important;
  }
  .admin-profile-tabs .nav-link:hover {
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-3">
      ...
      <div class="card card-primary">
        <div class="card-body card-profile">
          ...
          <a href="<?php echo url('admin/profile/index/edit') ?>" class="btn btn-primary btn-block"><b> <i class="fa fa-pencil"></i> <?php echo lang('edit') ?></b></a>
        </div>
        <!-- /.card-body -->
      </div>
      <!-- /.card -->
    ...
    <div class="card">
        <div class="card-body">
          <ul class="nav nav-pills admin-profile-tabs mb-3">
          ...
          <div class="<?php echo $activeTab=='edit'?'active':'' ?> tab-pane" id="editProfile">
            <?php echo form_open('/admin/profile/updateProfile', ['method' => 'POST', 'autocomplete' => 'off', 'class' => 'form-horizontal form-validate']); ?> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control"  minlength="5" data-rule-remote="<?php echo url('admin/users/check?notId='.$user->id) ?>" data-msg-remote="<?php echo lang('user_username_taken') ?>" name="username" id="inputUsername" required placeholder="<?php echo lang('user_username') ?>"  value="<?php echo $user->username ?>"/>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="email" name="email" required 
                   data-rule-remote="<?php echo url('admin/users/check?notId='.$user->id) ?>" data-msg-remote="<?php echo lang('user_email_exists') ?>"
          ...
          <div class="<?php echo $activeTab=='change_password'?'active':'' ?> tab-pane" id="changePassword">
            <?php echo form_open('/admin/profile/updatePassword', ['method' => 'POST', 'autocomplete' => 'off', 'class' => 'form-horizontal form-validate']); ?> 
          ...
          <div class="<?php echo $activeTab=='change_pic'?'active':'' ?> tab-pane" id="editProfilePic">
            <?php echo form_open('/admin/profile/updateProfilePic', ['method' => 'POST', 'autocomplete' => 'off', 'class' => 'form-horizontal form-validate', 'enctype' => 'multipart/form-data']); ?> 
