...
<?php
$is_skipped = ((string) ($page->submenu ?? '')) === 'skipped';
?>
...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><?php echo $is_skipped ? 'Skipped / Not Attempted' : 'Reports'; ?></h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Home</a></li>
          <li class="breadcrumb-item active"><?php echo $is_skipped ? 'Skipped' : 'Reports'; ?></li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex align-items-center justify-content-between">
          <h3 class="card-title mb-0"><?php echo $is_skipped ? 'Skipped Items' : 'Summary'; ?></h3>
          <div>
            ...
            <a class="btn btn-outline-secondary btn-sm" href="<?php echo base_url('admin/emarking/billing'); ?>">Billing</a>
          </div>
        </div>
      </div>
      <div class="card-body">
        <form method="get" class="mb-3">
          <div class="form-row">
            ...
            <?php else: ?>
              <div class="col-md-2 mb-2">
                <input type="text" name="emarker_id" value="<?php echo htmlspecialchars((string) ($filters['emarker_id'] ?? '')); ?>" class="form-control" placeholder="eMarker ID">
              </div>
              <div class="col-md-2 mb-2">
                <select name="status" class="form-control">
                  <option value="">All</option>
                  <option value="SKIPPED" <?php echo (($filters['status'] ?? '') === 'SKIPPED') ? 'selected' : ''; ?>>SKIPPED</option>
                  <option value="NOT_ATTEMPTED" <?php echo (($filters['status'] ?? '') === 'NOT_ATTEMPTED') ? 'selected' : ''; ?>>NOT_ATTEMPTED</option>
                </select>
              </div>
            <?php endif; ?>
              ...
              <tbody>
                ...
                <?php else: ?>
                  <?php foreach ($rows as $r): ?>
                    <tr>
                      <td><?php echo htmlspecialchars((string) $r->marked_at); ?></td>
                      <td><?php echo htmlspecialchars((string) $r->emarker_name); ?> (<?php echo (int) $r->emarker_id; ?>)</td>
                      <td><?php echo htmlspecialchars((string) $r->assessment_type); ?></td>
                      <td><?php echo (int) $r->grade; ?></td>
                      <td><?php echo htmlspecialchars((string) $r->subject_code); ?></td>
                      ...
                      <td><?php echo htmlspecialchars((string) $r->roll_no); ?></td>
                      <td><span class="badge badge-warning"><?php echo htmlspecialchars((string) $r->marking_status); ?></span></td>
