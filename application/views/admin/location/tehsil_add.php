    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"> <?php echo lang('tehsil_add') ?></li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
...
<section class="content">
  ...
  <div class="card">
    <div class="card-header with-border">
      <h3 class="card-title"> <?php echo lang('tehsil_add') ?></h3>
    ...
    <?php echo form_open_multipart('admin/location/tehsil_save', [ 'class' => 'form-validate' ], ); ?>
    <div class="card-body">
        <div class="row form-group">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="tehsil_name_en"> <?php echo lang('tehsil_name') ?></label>
                <input type="text" class="form-control" name="tehsil_name_en" id="tehsil_name_en" required placeholder="Enter Tehsil Name" autofocus />
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="tehsil_code"> <?php echo lang('tehsil_code') ?></label>
        		<input type="text" class="form-control" name="tehsil_code" id="tehsil_code" required placeholder="Enter Tehsil Code" autofocus />
            </div>
        </div>
        <div class="row form-group">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="tehsil_order"> <?php echo lang('tehsil_order') ?></label>
        		<input type="text" class="form-control" name="tehsil_order" id="tehsil_order" required placeholder="Enter Tehsil Order" autofocus />
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
$('#tehsil_state_id').on('change', function() {
      $.post('<?=base_url("admin/location/distirct_by_state")?>',
    {
