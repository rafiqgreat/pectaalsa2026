    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?php echo url('/admin/roles') ?>"><?php echo lang('roles') ?></a></li>
  ...
  <div class="card">
    <div class="card-header with-border">
      ...
      <div class="card-tools pull-right">
        <a href="<?php echo url('/admin/roles') ?>" class="btn btn-flat btn-default btn-sm"><i class="fa fa-chevron-left"></i> &nbsp;&nbsp; <?php echo lang('roles') ?></a>
    ...
    <?php echo form_open('admin/roles/save', [ 'class' => 'form-validate' ]); ?>
    <div class="card-body">
    ...
    <div class="card-footer">
      <div class="row">
        <div class="col"><a href="<?php echo url('/admin/roles') ?>" onclick="return confirm('Are you sure you want to leave?')" class="btn btn-flat btn-danger"><?php echo lang('cancel') ?></a></div>
