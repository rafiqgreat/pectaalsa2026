    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?php echo url('/admin/users') ?>"><?php echo lang('users') ?></a></li>
          <li class="breadcrumb-item"><a href="<?php echo url('/admin/users/view/' . $User->id) ?>"><?php echo $User->id ?></a></li>
...
<section class="content">
  ...
  <?php echo form_open_multipart('admin/users/update/' . $User->id, ['class' => 'form-validate', 'autocomplete' => 'off']); ?>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" data-rule-remote="<?php echo url('admin/users/check?notId=' . $User->id) ?>" data-msg-remote="<?php echo lang('user_username_take') ?>" name="username" id="formClient-Username" required placeholder="<?php echo lang('user_enter_username') ?>" value="<?php echo $User->username ?>" />
          </div>

          <div class="form-group">
            <label for="formClient-Email">Email</label>
            <input type="email" class="form-control" name="email" data-rule-remote="<?php echo url('admin/users/check?notId=' . $User->id) ?>" data-msg-remote="<?php echo lang('user_email_exists') ?>" id="formClient-Email" required placeholder="<?php echo lang('user_enter_email') ?>" value="<?php echo $User->email ?>">
          </div>
  ...
  <div class="card">
    <div class="card-footer">
      <div class="row">
        <div class="col"><a href="<?php echo url('/admin/users') ?>" onclick="return confirm('Are you sure you want to leave?')" class="btn btn-flat btn-danger"><?php echo lang('cancel') ?></a></div>
