...
<section class="content">
  <div class="card">
    ...
    <?php echo form_open('admin/school/save', ['class' => 'form-validate']); ?>
    <div class="card-body">
      <div class="row form-group">
        ...
        <div class="col-md-3">
          ...
          <input type="text" class="form-control" name="school_department" id="school_department">
        </div>
        <div class="col-md-3">
      ...
      <div class="row form-group">
        ...
        <div class="col-md-3">
          ...
          <input type="text" class="form-control" name="school_lsacode" id="school_lsacode">
        </div>
        <div class="col-md-3">
          <label for="school_area">Area</label>
          <input type="text" class="form-control" name="school_area" id="school_area">
        </div>
        <div class="col-md-3">
          <label for="school_students">Students</label>
          <input type="number" class="form-control" name="school_students" id="school_students" min="0">
        </div>
      </div>
        ...
        <div class="col-md-3">
          ...
          <select class="form-control" name="school_state_id" id="school_state_id">
            ...
            <?php foreach ($states as $state): ?>
              <option value="<?php echo $state->state_id; ?>"><?php echo $state->state_name_en; ?></option>
            <?php endforeach; ?>
          </select>
        </div>
        <div class="col-md-3">
      ...
      <div class="row form-group">
        ...
        <div class="col-md-3">
          ...
          <input type="number" class="form-control" name="school_grade" id="school_grade" min="0" value="4">
        </div>
        <div class="col-md-3">
