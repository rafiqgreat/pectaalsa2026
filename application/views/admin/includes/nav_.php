    ...
    <li class="nav-item has-treeview <?php echo ($page->menu == 'results') ? 'menu-open' : ''; ?>">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="<?php echo url('admin/emarking/reports_english_marks_csv'); ?>" class="nav-link <?php echo ($page->menu == 'results' && $page->submenu == 'complete_english_marks_csv') ? 'active' : ''; ?>">
              <i class="far fa-circle nav-icon"></i>
              <p>English Marks CSV</p>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="<?php echo url('admin/emarking/reports_urdu_marks_csv'); ?>" class="nav-link <?php echo ($page->menu == 'results' && $page->submenu == 'complete_urdu_marks_csv') ? 'active' : ''; ?>">
              <i class="far fa-circle nav-icon"></i>
              <p>Urdu Marks CSV</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo url('admin/emarking/reports_math_marks_csv'); ?>" class="nav-link <?php echo ($page->menu == 'results' && $page->submenu == 'complete_math_marks_csv') ? 'active' : ''; ?>">
              <i class="far fa-circle nav-icon"></i>
              <p>Math Marks CSV</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo url('admin/emarking/reports_science_marks_csv'); ?>" class="nav-link <?php echo ($page->menu == 'results' && $page->submenu == 'complete_science_marks_csv') ? 'active' : ''; ?>">
              <i class="far fa-circle nav-icon"></i>
              <p>Science Marks CSV</p>
            </a>
          </li>
          <li class="nav-item">
