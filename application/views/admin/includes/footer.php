...
<!-- ./wrapper -->
  ...
  <footer class="main-footer">
    <?php /*?><div class="float-right d-none d-sm-block">
    Made with <i class="fa fa-heart" style="color: red;"></i> for Developers
      &nbsp; &nbsp; &nbsp; &nbsp; 
      <b>Version</b> 2.0
    </div><?php */?>
    <strong>Copyright &copy; <?php echo date('Y') ?> <a href="<?php echo url('/admin/') ?>"><?php echo setting('company_name') ?></a>.</strong> All rights
    reserved.
  </footer>
