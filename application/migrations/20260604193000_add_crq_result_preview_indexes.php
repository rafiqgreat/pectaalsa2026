...
class Migration_Add_crq_result_preview_indexes extends CI_Migration
{
	...
	public function up()
	{
		if ($this->db->table_exists('emarking_question_images')) {
			$this->add_index_if_missing(
				...
				'idx_crq_result_preview',
				'`assessment_type`, `grade`, `subject_code`, `version`, `school_id`, `roll_no`, `question_id`, `source_table`, `source_paper_id`'
			);
		}
	}
