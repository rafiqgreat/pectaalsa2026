...
if (!function_exists('userProfile')) {
	...
	{
		$CI = &get_instance();
		$default = base_url('assets/img/avatar5.png');
...
if (!function_exists('user_access_blocked')) {
	function user_access_blocked()
	{
		return setting('user_access_blocked') === '1';
	}
}
if (!function_exists('user_access_block_message')) {
	function user_access_block_message()
	{
