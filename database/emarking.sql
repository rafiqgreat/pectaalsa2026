...
-- QC / Subject Specialist Quality Check (separate from normal eMarker marking)
CREATE TABLE `emarking_qc_batches` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `batch_code` VARCHAR(100) NOT NULL,
  `assessment_type` ENUM('CRQ','DICTATION') NOT NULL DEFAULT 'CRQ',
  `grade` INT NOT NULL,
...
CREATE TABLE `emarking_qc_batch_items` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `batch_id` BIGINT NOT NULL,
  `question_image_id` BIGINT NOT NULL,
  `question_id` INT NOT NULL,
...
CREATE TABLE `emarking_qc_marks` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `batch_item_id` BIGINT NOT NULL,
  `question_image_id` BIGINT NOT NULL,
  `question_id` INT NOT NULL,
...
CREATE TABLE `emarking_qc_marks_steps` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `mark_id` BIGINT NOT NULL,
  `rubric_step_id` INT NOT NULL,
  `selected_value` VARCHAR(50) DEFAULT NULL,
